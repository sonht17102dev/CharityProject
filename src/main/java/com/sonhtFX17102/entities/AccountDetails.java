...
public class AccountDetails {
	...
	public String toString() {
		return "AccountDetails [account_id=" + account_id + ", account_firstName=" + account_firstName
				...
				+ account_organization + ", account_bank=" + account_bank + ", account_bankname=" + account_bankname
	...
	public AccountDetails(String account_firstName, String account_lastName, String account_image,
			String account_address, String account_birthday, String account_organization, String account_bank,
			String account_bankname, long total_donated) {
		super();
		this.account_firstName = account_firstName;
		this.account_lastName = account_lastName;
		this.account_image = account_image;
