                ...
                <div class="row">
                    <div class="col-lg-6 introduce_partner">
                       ...
                       <div class="infomation">
                        <ul>
                            <li><a href="#" data-scroll-nav='1' class="btn-Donate">Quyên góp</a></li>
                            <li><a href="#" data-scroll-nav='1' class="btn-Donate">Giới thiệu</a></li>
                        </ul>
                    </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb-55">
                        <h3><span>Chương trình Quyên góp</span></h3>
                	...
                	<div class="single_cause box-cause">
                            ...
                            <div class="causes_content">
                                <div class="custom_progress_bar">
                                    ...
                                    <c:if test="${percent < 100}" >
                                        <div class="progress-bar" role="progressbar" style="width: ${percent}%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">
                                            <span class="progres_count">
                                                <fmt:formatNumber type = "percent" maxIntegerDigits="2" value = "${percent}" />
                                            </span>
                                        </div>
                                    </c:if>
                                </div>
                                <div class="balance d-flex justify-content-between align-items-center">
                                    <span>Raised: <fmt:formatNumber type = "number" value = "${circumsOfPartner.circum_target}" />đ </span>
                                    <span>Goal: <fmt:formatNumber type = "number" value = "${circumsOfPartner.circum_raise}" />đ </span>
                                </div>
                                <h4>${circumsOfPartner.circum_name}
                                </h4>
                                <div class="infomation">
                                    <ul>
                                        <li>Lượt quyên góp <br>
                                        <span><fmt:formatNumber type = "number" value = "${circumsOfPartner.circum_donations}" /></span></li>
                                        <li>Đạt được <br><span><fmt:formatNumber type = "number" 
         maxFractionDigits = "3" value = "${percent}"/>%</span></li>
         								<c:if test="${percent >=100}">
         								<li><a href="#" data-scroll-nav='1' class="btn-Donate">Đạt mục tiêu</a></li>
         								</c:if>
         								<c:if test="${percent < 100}">
                                        <li><a href="quyen-gop" data-scroll-nav='1' class="btn-Donate">Quyên góp</a></li>
                                    	</c:if>
                                    </ul>
                                </div>
                            
                                <a class="read_more" href="hoan-canh-chi-tiet?id=${circumsOfPartner.circum_id}">Đọc thêm </a>
                            </div>
                        </div>   
                     </c:forEach> 
                </div>
		...
		<div class="container box_1170">
            <div class="section-top-border">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="section_title text-center mb-55">
                            <h3 class="deep-pink"><span>Các đối tác đồng hành khác</span></h3>
                            <p>Các tổ chức nhân đạo Phi Lợi Nhuận đồng hành cùng Ví MoMo giúp đỡ các hoàn cảnh khó khăn trên khắp cả nước.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4 our-partner" >
                        ...
                        <div class="single-defination">
                            ...
                            <p><a href="doi-tac-chi-tiet?id=${list.partner_id}">Xem chi tiết >></a></p>
                        </div>
                    </div>
                    </c:forEach>
                </div>
