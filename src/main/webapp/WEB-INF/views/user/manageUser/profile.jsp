...
<div class="container-xl px-4 mt-4 mb-4" style="margin-top: 70px !important;">
	...
	<div class="row">
		<div class="col-xl-4">
			...
			<div class="card mb-4 mb-xl-0">
				<div class="card-header deepPink">Hình đại diện</div>
				<div class="card-body text-center ">
					...
					<form action="${pageContext.request.contextPath}/tai-khoan/uploadfile" 
					method="post" enctype="multipart/form-data">
						<input type="hidden" id="username" name="username"
								value="${info.account_name}" readonly>
		...
		<div id="changeInfo" class="col-xl-8">
			<div class="card mb-4">
				<div class="card-header deepPink">
					Thông tin tài khoản
				...
				<div class="card-body">
					<form id="formInfo" method="post" action="${pageContext.request.contextPath}/tai-khoan/cap-nhat">
						...
						<div class="row gx-3 mb-3">
							...
							<div class="col-md-6">
								<label class="mb-1" for="inputOrgName">Tên tổ chức</label>
						...
						<div class="mb-3">
							<label class="mb-1" for="inputEmailAddress">Địa chỉ
						...
						<div class="row gx-3 mb-3">
							...
							<div class="col-md-6">
								<label class="mb-1" for="inputBank">Số tài khoản</label>
							...
							<div class="col-md-6">
								<label class="mb-1" for="inputBankname">Ngân hàng</label>
								<input class="form-control" id="bankname" type="text"
									name="bankname" placeholder="Nhập tên ngân hàng của bạn" 
