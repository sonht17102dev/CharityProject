					...
					<form id="formInfo" method="post" action="">
						...
						<div class="mb-3">
							<label class="small mb-1" for="inputUsername">Username
								...
								trên trang web)</label> <input class="form-control" id="inputUsername"
								type="text" placeholder="Nhập username của bạn" value="">
						</div>
						...
						<div class="row gx-3 mb-3">
							...
							<div class="col-md-6">
								...
								<input class="form-control" id="orgName" name="orgName"
									type="text" placeholder="Nhập tên tổ chức của bạn" value="">
							</div>
						...
						<div class="mb-3">
							<label class="small mb-1" for="inputEmailAddress">Địa chỉ
								...
								type="email" placeholder="Nhập địa chỉ email của bạn" value="">
						</div>
						...
						<div class="row gx-3 mb-3">
							...
							<div class="col-md-6">
								...
								<input class="form-control" id="birthday" type="text"
									name="birthday" placeholder="Nhập ngày sinh của bạn" value="">
							</div>
						</div>
